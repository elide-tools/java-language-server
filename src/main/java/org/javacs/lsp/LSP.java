            ...
            try {
                ...
                switch (r.method) {
                    ...
                    case "textDocument/implementation":
                        {
                            var params = gson.fromJson(r.params, TextDocumentPositionParams.class);
                            var response = server.findImplementations(params);
                            respond(send, r.id, response);
                            break;
                        }
                    ...
                    case "textDocument/declaration":
                        {
                            var params = gson.fromJson(r.params, TextDocumentPositionParams.class);
                            var response = server.declaration(params);
                            respond(send, r.id, response);
                            break;
                        }
                    ...
                    case "callHierarchy/incomingCalls":
                        {
                            var params =
                                    gson.fromJson(r.params, CallHierarchyIncomingCallsParams.class);
                    ...
                    case "callHierarchy/outgoingCalls":
                        {
                            var params =
                                    gson.fromJson(r.params, CallHierarchyOutgoingCallsParams.class);
                    ...
                    case "typeHierarchy/supertypes":
                        {
                            var params =
                                    gson.fromJson(r.params, TypeHierarchySupertypesParams.class);
                    ...
                    case "textDocument/diagnostic":
                        {
                            ...
                            var response = server.documentDiagnostics(params);
                            respond(send, r.id, response);
                            break;
                        }
                    case "workspace/diagnostic":
                        {
                            var params = gson.fromJson(r.params, WorkspaceDiagnosticParams.class);
                            var response = server.workspaceDiagnostics(params);
                            respond(send, r.id, response);
                            break;
                        }
                    case "$/cancelRequest":
