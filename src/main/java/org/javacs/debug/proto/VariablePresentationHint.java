...
public class VariablePresentationHint {
     ...
     * Values: 'property': public * Indicates that the object is a property. 'method': Indicates
     * that the object is a method. 'class': Indicates that public * the object is a class. 'data':
     * Indicates that the object is data. 'event': Indicates that the object is an event. public *
     * 'baseClass': Indicates that the object is a base class. 'innerClass': Indicates that the
     * object is an inner public * class. 'interface': Indicates that the object is an interface.
