...
public class ExceptionOptions {
    ...
    /**
     * Condition when a thrown exception should result in a break. never: never breaks, always:
     * always breaks, unhandled: breaks when excpetion unhandled, userUnhandled: breaks if the
