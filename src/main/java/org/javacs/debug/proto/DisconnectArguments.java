...
public class DisconnectArguments {
     ...
     * unspecified, the debug adapter is free to do whatever it thinks is best. A client can only
     * rely on this attribute being properly honored if a debug adapter returns true for the
